                                                               ...
                                                               foreach (GenericPackageProperty packageProperty in enumerable)
                                                               {
                                                                   ...
                                                                   switch (packageProperty.SerilizeType)
                                                                   {
                                                                       ...
                                                                       case SerilizeType.ConstString:
                                                                           ...
                                                                           definition.AddDefintion(new UnpackPropertyDefinition<IEntryData>(propertyName, SerilizeType.String, (data, unpacker, arg3) => propertyInfo.SetValue(data, property.Value)));
                                                                           break;
                                                                       default:
