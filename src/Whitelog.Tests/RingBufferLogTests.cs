...
namespace Whitelog.Tests
{
    ...
    public class RingBufferLogTests
    {
        ...
        public void SimpleLogMessageWork()
        {
            ...
            {
                var m_cfl =  new InMemmoryBinaryFileLogger(ringBufferLogFactory,ringBufferLogFactory);
                ...
                var m_logReader = readerFactory.GetLogReader(m_cfl.Stream, m_testConsumer);
