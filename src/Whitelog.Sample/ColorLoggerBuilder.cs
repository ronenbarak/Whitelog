        ...
        private void m_btnBuild_Click(object sender, EventArgs e)
        {
            if (m_cboLayout.SelectedIndex >= 0)
            {
                ...
                if (m_chkDefaultColors.Checked)
                {
                    ...
                    (m_cboLayout.SelectedItem as LayoutLogger).AddStringAppender(new ProxyConsoleAppander(richTextBox, defualtColorSchema));   
                }
                else
                {
                    ...
                    (m_cboLayout.SelectedItem as LayoutLogger).AddStringAppender(new ProxyConsoleAppander(richTextBox, colorSchema));   
                }
            }
